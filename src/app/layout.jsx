import './globals.css';
export const metadata = { title: 'Brad Dorsey — Artist', description: 'Visual artist exploring identity, culture, and the human condition through mixed media and painting.', themeColor: '#0A0908' };
